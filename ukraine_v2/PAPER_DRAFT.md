...
**Wave disaggregation as a structural test.** To directly test whether the 4.04-year gap is driven by the most privileged emigrant sub-group, all 1,313 migrant entries were classified into emigration waves using period-of-departure extracted from biographical text (see Stage 9 methodology). Results are shown in Table WD. Figure 29 shows Kaplan–Meier survival curves by wave.

**Table WD. Emigration wave disaggregation — mortality by wave vs non-migrant reference**

| Wave | n | Mean age at death (95% CI) | Gap vs non-mig | % died <50 | % survived ≥80 | MW p-value |
|------|---|---------------------------|----------------|-----------|----------------|-----------|
| Non-migrated (ref) | 6,030 | 71.22 (70.87–71.57) | — | 7.1% | 29.8% | — |
| Wave 1: pre-1922 UNR/Civil War flight | 212 | 73.62 (71.23–75.76) | +2.41 yrs | 11.3% | 41.5% | 0.0002 |
| Wave 2: 1939–45 WWII displacement | 203 | 70.34 (68.27–72.49) | −0.88 yrs | 9.9% | 31.5% | 0.63 |
| Wave 3: 1946–91 Cold War emigration | 632 | 75.66 (74.77–76.53) | +4.44 yrs | 2.4% | 39.2% | <0.001 |
| Wave 4: post-1992 (excluded from gap) | 172 | 86.62 (85.38–87.86) | — | 0% | 85.6% | — |

**Figure 29.** Kaplan–Meier survival curves by emigration wave and non-migrant reference. Wave 3 workers — who lived under Soviet conditions longest before emigrating — show the clearest survival advantage. Wave 2 workers who endured WWII displacement and DP camps show near-identical survival to non-migrants.

**Figure 29b.** Emigration volume by decade, stacked by wave. The three historically distinct emigration peaks are visible: Wave 1 concentrated in the late 1910s (UNR collapse, Civil War), Wave 2 in the early 1940s (WWII westward flight), and Wave 3 spread across 1946–1991 (Cold War-era defectors and dissidents). Each wave represents a structurally different selection mechanism.

**Figure 29c.** Age at death by emigration wave (box plots). Box spans IQR; horizontal line = median; diamond = mean; dashed reference line = non-migrant mean (71.2 years). Wave 3 workers (Cold War emigration, n=634) show the highest mean age at death (75.6y, gap +4.4y); Wave 2 workers displaced by WWII (n=203) show near-identical longevity to non-migrants (70.3y, gap −0.9y, p=0.63); Wave 1 workers (pre-1922, n=212) show a modest advantage (73.6y, gap +2.4y). The divergent pattern across waves with structurally distinct selection mechanisms is inconsistent with a single positive-selection confound.

The wave-level pattern is structurally important for interpreting the self-selection critique. Wave 1 emigrants — the sub-group most selected for pre-existing privilege — show a *smaller* gap (+2.41 years) than Wave 3 emigrants (+4.44 years). Wave 2, who experienced the most severe emigration hardship (displacement, DP camps, malnutrition, resettlement uncertainty), shows essentially no gap (−0.88 years, p=0.63). The adjusted OLS model (controlling for birth decade and profession) replicates this pattern: Wave 3 shows a significant adjusted coefficient of +4.54 years (p<0.001); Waves 1 and 2 are not significantly different from non-migrants after adjustment.

This cross-wave pattern is inconsistent with a simple positive-selection story. If the gap were explained primarily by pre-migration advantages (health, social capital, wealth), we would expect the most privileged sub-group — Wave 1 — to show the *largest* gap. Instead, the largest gap belongs to Wave 3: workers who spent their productive careers under Soviet conditions and only managed to leave in the post-war Cold War period, often at great personal and political cost. The selection mechanisms for each wave are historically incommensurable — early elite flight, WWII chaos, Cold War defection — yet only the wave with the longest Soviet exposure shows the substantial mortality advantage. This pattern argues against a unified unobserved confound driving the result.

Wave classification relies on period-of-departure keywords and year mentions in English biographical reasoning text. Approximately 5.0% of migrants (n=66) could not be assigned to a wave and are retained in the aggregate migrant group but excluded from wave-level breakdowns. Wave 4 emigrants (post-1992, n=172) are excluded from the gap calculation entirely as they did not leave the Soviet sphere.
