...
The gap is not uniform: it is largest for the 1880s and 1890s birth cohorts (the Executed Renaissance generation, with identical gaps of 5.1 years for both cohorts), for Architects (+6.1 years) and Other Creative workers (+4.9 years), and for workers born in western Ukrainian cities (who emigrated at rates of 35–53% compared to near-zero rates in eastern Ukraine). It narrows substantially for the post-Terror cohorts, providing strong evidence that the gap is driven primarily by cohort-specific political violence rather than by stable baseline differences between migrants and non-migrants.
