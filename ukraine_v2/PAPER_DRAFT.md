...
Quantitative study of this mortality toll has been limited. Historical demography of Soviet persecution has relied heavily on archival records — many still restricted or destroyed — and has focused more on aggregate victim counts than on comparative mortality across survivor groups. Qualitative accounts of Soviet cultural repression are extensive and well-documented (Snyder 2010; Applebaum 2003; Conquest 1968; Grabowicz 1982; Shkandrij 2010), but almost no systematic quantitative evidence exists for the demographic consequences of Soviet cultural policy at the level of an entire professional class. The question is tractable: the Encyclopedia of Modern Ukraine (ESU) provides biographical data for thousands of creative workers, including birth and death years for the vast majority. If the mortality gap is large and robust, it constitutes quantitative corroboration of what historians have documented through archival and testimonial evidence — not merely for individual victims, but for an entire professional class.

The central research question of this study is: **Did Ukrainian creative workers who emigrated from Soviet-controlled territory live measurably longer than those who remained?** We find that they did — by 3.98 years — and that this gap constitutes the first large-scale quantitative evidence of the demographic cost of Soviet cultural policy for an entire professional class. The finding is not driven by a single profession, cohort, or region; it survives regression adjustment and propensity score matching; and it is specific to exit from Soviet jurisdiction — workers who moved within the USSR gained no advantage. The most severe signal is among workers deported by the Soviet state, who died on average 22 years earlier than non-migrants, with peak mortality concentrated in a single year: 1937.
...
### 2.2 Present Study (V3.0, n=8,585)
...
| Cox PH | Not performed | HR=0.777 [0.731, 0.828] |
...
- *Excluded duplicate* (n=4): Exact duplicate ESU entries (same name, birth year, death year).
- *Excluded non-person* (n=1): ESU entry for an artwork or film title, not an individual.
...
**Cox Proportional Hazards:** Complete-case model (n=8,585; all event_observed=1). Adjusted model adds birth decade, profession, region. PH assumption tested via Schoenfeld residuals. Right-censored supplementary analysis adds living individuals (n=15,165 total). A hazard ratio (HR) below 1.0 indicates lower mortality risk; above 1.0 indicates higher risk.
...
The complete ESU scrape yielded 16,215 entries. After applying inclusion/exclusion criteria (see §3.2), 8,585 deceased individuals with complete birth and death year data entered the analysis. Group composition: migrated 1,323 (15.4%), non-migrated 5,957 (69.4%), internal transfer 1,111 (12.9%), deported 195 (2.3%). Gender: 7,191 male (83.8%), 1,358 female (15.9%), 36 unknown (0.4%). Birth years range from 1840 to 1982; the majority were born between 1870 and 1940.
...
|---|---|---|---|---|---|
| Migrated | 1,323 | 75.43 | 77 | 13.85 | [74.68, 76.17] |
| Non-migrated | 5,957 | 71.45 | 73 | 13.59 | [71.10, 71.79] |
| Internal transfer | 1,111 | 71.09 | 73 | 13.59 | [70.29, 71.89] |
| Deported | 194 | 49.43 | 46 | 15.41 | [47.26, 51.60] |
...
| Migrated vs Deported | +26.00 yrs | 1.850 | <0.001 |
| Non-migrated vs Deported | +22.02 yrs | 1.613 | <0.001 |
| Non-migrated vs Internal transfer | +0.36 yrs | 0.026 | 0.267 (NS) |
...
OLS regression confirms the gap survives adjustment for birth cohort, profession, and region: the migrated coefficient falls from +3.98 to +2.72 years (Model 2, R²=0.085, F=61.54, p<0.001; **Figure 10**). Propensity score matching narrows the gap to +3.43 years (bootstrap 95% CI: 2.38–4.51), a 13.8% attenuation — the migrant advantage cannot be explained by measured selection covariates alone.

Cox proportional hazards modelling (**Figure 11**) yields an adjusted HR of 0.777 [0.730, 0.828] for migrants — approximately 22% lower instantaneous mortality risk at any given age. Deported workers show HR=4.403 [3.805, 5.095] — more than four times the mortality hazard. The internal transfer HR (1.09) is marginally elevated but orders of magnitude smaller, consistent with the null result in the mean comparison. The proportional hazards assumption is violated for all three migration groups (Schoenfeld residual test p<0.001 for all); reported HRs are therefore average effects over the full follow-up period. Time-varying analysis for the deported group, where the violation is most substantively important, is presented in §4.2.

### 4.2 Deported Workers Died 22 Years Earlier

The deported group represents the study's most analytically important finding. Their mean age at death of 49.43 years — a 22.02-year deficit relative to non-migrants (Cohen's d=1.613) — is the direct demographic signature of Soviet political violence.
...
**Death year clustering.** **Figure 5** shows deported workers' deaths clustering sharply in 1937–38. Sixty-six of the 194 deported workers (34.0%) died in 1937 alone — the year of peak Stalinist terror. Their mean age at death in 1937 was 42.7 years. **Figure 6** shows the year-by-year breakdown.

**The 1937 spotlight.** The Sandarmokh massacres of November 1937 account for a substantial fraction of the 1937 deaths. Soviet security services executed hundreds of Ukrainian cultural figures in a matter of months during the Great Terror. The ESU captures many of these individuals through archival and memorial records, but — as Section 5.3 documents — many others are absent from the ESU entirely.

**Time-varying hazard.** The PH assumption is violated for the deported group (Schoenfeld residual test p=0.0). Landmark Cox analysis (**Figure 12**) shows peak HR=1.86 at age 40–50 — the Terror-period execution window. By ages 70–80, deportee survivors show mortality hazard indistinguishable from non-migrants (HR=1.19, NS), consistent with survivor selection: those who survived the terror and camp system tended to be unusually resilient.

**Period breakdown for non-migrants.** Table 3 shows non-migrant deaths by historical period:
...
| Post-1991 | 3,713 | 74.7 | 62.3% |

The dominance of post-1991 deaths (62.3% of non-migrants) reflects the large cohort of Soviet-era workers who survived into Ukrainian independence. The non-migrant mean of 71.45 incorporates these long-lived survivors — meaning the observed gap is not an artefact of a depressed non-migrant mean; the non-migrant mean is itself elevated by post-Soviet longevity.

### 4.3 Moving Within the Soviet System Did Not Help

The internal transfer group — workers who relocated within the USSR but did not exit Soviet jurisdiction — shows no significant mean age at death advantage over non-migrants: +0.36 years, p=0.267 (NS), Cohen's d=0.026. **Figure 7** illustrates this near-zero gap.

This null result is the study's most important control finding, and it directly addresses the most obvious alternative explanation for the migrant advantage: the "healthy migrant" hypothesis — the possibility that people who move are simply healthier, more resourceful, or more privileged than those who stay, regardless of where they move to. If that were the primary driver, internal transfers should also show a survival advantage. They moved comparable distances, navigated comparable institutional barriers, and disrupted their lives comparably. Yet they gained nothing. The survival advantage is not associated with geographic mobility itself — it is specifically associated with exit from Soviet political jurisdiction. This distinction is critical: it shifts the interpretive weight from selection (who chose to leave) toward treatment (what they were leaving behind).

### 4.4 The Gap Holds Across Professions, Cohorts, Genders, and Geography

**Profession.** The migrant advantage is not driven by a single profession. **Figure 8** and Table 4 show the gap across all six profession categories:

**Table 4: Age at death by profession and migration group**

| Profession | Migrated LE | n | Non-mig LE | n | Dep LE | n | Gap (M−NM) |
|---|---|---|---|---|---|---|---|
| Writers/Poets | 74.5 | 389 | 70.5 | 1,753 | 46.0 | 123 | +4.0 |
| Visual Artists | 74.8 | 384 | 71.6 | 1,954 | 56.9 | 39 | +3.2 |
| Musicians/Composers | 75.8 | 308 | 71.5 | 914 | 45.1 | 13 | +4.4 |
...
Writers/Poets — the group most associated with the Executed Renaissance — show a gap (+4.0 yrs) consistent with the overall finding. The fact that the advantage is present in every category rules out a simple "Writers were targeted more" confounding story. Among deportees, Writers/Poets show the youngest mean age at death (46.0 yrs, n=123), consistent with the literary intelligentsia bearing the brunt of the Great Terror.

**Birth cohort.** **Figure 9** shows mean age at death by birth decade. The gap is largest for the 1880s (+5.0 yrs) and 1890s (+4.6 yrs) cohorts — the Executed Renaissance generation — and smallest for the 1930s cohort (+1.7 yrs), consistent with the post-Stalinist easing of direct violence.
...
| 1890s | 75.4 | 231 | 70.8 | 325 | 44.7 | 61 | +4.6 |
| 1900s | 75.2 | 218 | 72.4 | 650 | 44.2 | 59 | +2.8 |
| 1910s | 77.6 | 219 | 74.9 | 808 | 46.9 | 13 | +2.7 |
| 1920s | 78.9 | 167 | 75.4 | 1,259 | 53.2 | 6 | +3.5 |
| 1930s | 74.9 | 92 | 73.2 | 1,136 | 77.8 | 4 | +1.7 |

**Gender.** Male workers dominate all groups (migrants: 79.3% male; deported: 92.7% male; 36 entries across all groups have unknown gender). The migrant survival advantage holds for both genders. Female migrants live notably longer than male migrants (78.1 vs 74.6 yrs). Full gender breakdowns are provided in Appendix A, Figures A7–A8.

**Geography.** Lviv (44.8% migrated) and Ternopil (52.9%) show migration rates three to four times higher than Kyiv (13.9%), consistent with geographic proximity to western borders and Habsburg/Polish emigration networks. The Donetsk 0.0% reflects the complete absence of emigration from this heavily Russified industrial city.

**Temporal structure.** The period analysis (Table 3) reveals two critical patterns. Mean age at death rises monotonically from the Early Soviet period (58.4 yrs) through Post-1991 (74.7 yrs). The dominance of post-1991 deaths (62.3% of all non-migrant deaths) means the 3.98-year gap is conservative. Migrants are more than twice as likely to reach age 90 (15.0% vs 6.3% of non-migrants).

### 4.5 Sensitivity and Robustness

**AI error sensitivity.** **Figure 13** shows the gap as a function of AI error rate. The finding remains positive up to approximately 8% error. Our validated rate (3.2%) is well within the safe margin. At 3.2% error, the sensitivity-adjusted gap is 3.24 years; at 10% error, it remains positive at 1.84 years. Three additional robustness scenarios (duration assumptions, post-Soviet emigrant handling, bootstrap misclassification) are summarised in Appendix B; the finding persists across all specifications.

**Missing-worker bias.** **Figure 14** quantifies the ESU's coverage bias. Seven individuals confirmed to meet study inclusion criteria are absent from the ESU (see §5.3 for names). Their mean age at death is 46.7 years — 25 years below the non-migrant mean. Adding these 7 workers widens the gap to 4.01 years; adding 50 plausible missing workers at a conservative assumed mean of 38 years widens it to 4.26. Under no plausible assumption does adding missing repressed workers *narrow* the gap — the estimate is a conservative lower bound.

**Right-censored supplementary analysis** (N=15,165 including right-censored living individuals): Migrated HR=1.346 (95% CI: 1.262–1.434). The reversal relative to the complete-case model reflects the censoring imbalance: ~52% of non-migrants are right-censored while essentially all migrants are deceased. The complete-case model (HR=0.777) is the primary result. Censoring patterns are documented in Appendix A, Figures A11–A12.

---

## 5. Discussion

### 5.1 What These Patterns Establish

The convergence of evidence presented in Section 4 points to a primary conclusion: **Soviet conditions — particularly state-organised violence and its secondary effects — shortened the lives of the Ukrainian creative workers who remained under Soviet control.** The evidence for this interpretation rests on three pillars, each of which independently constrains alternative explanations.

**First, the deportee deficit is a direct violence signature.** The 22.02-year gap between non-migrants and deportees (Cohen's d=1.613) is not a statistical inference about systemic disadvantage — it is the demographic imprint of state-organised killing. The 91 non-migrated and deported deaths concentrated in 1937 alone (average age ~44.5), the near-total destruction of the 1890s deported cohort (mean age at death 44.6 years), and the time-varying Cox analysis showing peak hazard at ages 40–50 — the exact window when Terror-era deportees were in their prime — all point to excess mortality from direct state violence that had no equivalent in migrant communities. This is not a contested inference; it is the ESU's quantitative capture of historically documented events.

**Second, the internal transfer null result rules out selection as the dominant explanation.** If the 3.98-year migrant advantage were primarily driven by selection effects — healthier, wealthier, or more resourceful people choosing to leave — we would expect any form of geographic mobility to confer some advantage. It does not. Internal transfers gained nothing (+0.36 yrs, p=0.267). They navigated comparable institutional barriers, relocated comparable distances, and disrupted their lives comparably — yet their mortality is indistinguishable from non-migrants. The advantage is specific to exiting Soviet jurisdiction.

**Third, the gap's cohort structure matches the historical timing of repression.** The birth cohort analysis (Table 5) shows the gap is largest for the 1880s (+5.0 yrs) and 1890s (+4.6 yrs) cohorts — the Executed Renaissance generation, at peak vulnerability during the Great Terror — and smallest for the 1930s cohort (+1.7 yrs), who came of age after the worst Stalinist violence had ended. If the gap were driven primarily by baseline differences between migrants and non-migrants, we would expect it to be more uniform across cohorts. Instead, it tracks the historical intensity of repression. This pattern, combined with the gap's persistence after regression adjustment (+2.72 yrs) and propensity score matching (+3.43 yrs), and its presence across all six profession categories (Table 4), argues against a simple compositional or selection-driven explanation.

Selection effects are real and acknowledged. Workers who emigrated may have been positively selected for resourcefulness, social capital, and health. This study cannot fully distinguish the selection component from the treatment component; wave-level disaggregation (deferred to future work, see §5.4) would be required. But the internal transfer control, the cohort patterning, and the consistency across subgroups collectively constrain the plausible magnitude of selection effects — they cannot explain the full pattern observed.

### 5.2 Association, Not Causation
...
**ESU coverage bias.** The ESU disproportionately covers culturally prominent individuals. Workers who were arrested, killed, and whose work was suppressed may have smaller or absent entries. This bias is asymmetric: the most severely repressed workers are most likely to be missing. Current estimates are therefore **conservative lower bounds** on the true mortality differential. Seven confirmed missing individuals illustrate this: Vasyl Stus (died Perm-36, age 47), Mykola Khvylovy (suicide, age 40), Mykola Zerov (shot Sandarmokh, age 47), Les Kurbas (shot Sandarmokh, age 50), Mykola Kulish (shot Sandarmokh, age 45), Oles Dosvitniy (shot, age 43), Mykola Boychuk (shot, age 55). Their mean age at death is 46.7 years. Ages are calculated as death_year minus birth_year, consistent with the study's primary method.

**Classification quality.** The validated AI error rate is 3.2%, based on a complete 200-entry stratified review. Errors were concentrated in near-boundary Galician cases. The sensitivity analysis confirms the finding holds robustly to approximately 8% error.

**Observational design.** This is an observational study. Causal inference is limited by self-selection into migration, unmeasured confounders, and the impossibility of a counterfactual. PSM partially addresses measured confounders; unmeasured ones cannot be controlled with available data.

**Post-Soviet composition.** 61% of non-migrant deaths occurred after 1991. The gap captures lifetime exposure — not purely Soviet-period exposure. This is appropriate for a lifespan study but means the gap cannot be read as reflecting Soviet-period mortality differentials alone.

**Galician survival selection.** Workers from Galicia had earlier and easier access to emigration routes and experienced Soviet rule only from 1939. Their inclusion in the "migrated" category means some of the observed advantage may reflect different exposure history rather than emigration per se. Galicia pre-annexation entries are excluded from the analysis (see §3.2), but Galicians who remained in the Soviet system post-1939 are included.

**Wave disaggregation deferred.** An early analysis (Stage 9) attempted to disaggregate migrants by emigration wave (pre-1922, 1939–45, 1946–91). The classifier proved unreliable: it recovered birth and death years from biographical text rather than actual emigration dates, leading to spurious wave assignments. This analysis was retracted. Wave disaggregation is the primary V3 data collection priority.

**Living cohort assumptions.** The right-censored supplementary Cox analysis treats living individuals as censored at 2026. This introduces bias because living individuals are concentrated in the non-migrated group (~52% censored). The complete-case Cox (HR=0.777) is the primary model.

### 5.4 Historical Interpretation and Prior Research

The 1880–1910 birth cohorts show the largest migrant/non-migrant gaps (+5.0 yrs for the 1880s, +4.6 yrs for the 1890s). These individuals were in their 30s and 40s — peak productive and politically vulnerable ages — during the Great Terror (1937–38) and the wartime period (1941–45). For these cohorts, the decision or opportunity to emigrate was, in many documented cases, literally life or death.

The 1937 death concentration among deportees (66 of 194 died in 1937, mean age 42.7; deported workers dying in the 1934–38 period had a mean age of just 43.5 years; those in 1939–45 died at mean 45.0 years) reflects the Sandarmokh massacres and the broader Great Terror, when Soviet security services executed thousands of Ukrainian cultural figures in months. This is not a statistical artefact — it is the ESU's partial capture of a historically documented event.
...
The reduction in the measured gap from V1 (+9.0 yrs) to V3.0 (+3.98 yrs) does not represent a finding that Soviet repression was less lethal than previously estimated. The narrowing is driven by two methodological changes: V1's pre-1991 death cutoff and non-systematic sampling. The V3.0 estimate is more conservative and more defensible.

Our findings are broadly consistent with existing historical scholarship on Soviet repression. Studies of Gulag mortality document catastrophic death rates in Soviet labour camps, reaching 20–25% annually during 1942–1943. Comparative demography of Soviet versus Western European general populations documents a Soviet mortality penalty that grew from approximately 3 years in the mid-1960s to over 10 years by the early 1990s. Our finding of a 3.98-year migrant advantage is consistent with the lower end of this range, though our dataset captures both the general Soviet mortality penalty and the profession-specific repression effect.

**Figure 15** shows ESU group means overlaid on Ukrainian SSR general population estimates. **Figure 16** provides a simplified view using annual death rates normalised by group size, making the WWII-era mortality spike and the relative proportions of death across groups clearly visible. Together, these two figures contextualise the creative worker mortality patterns against the broader Ukrainian demographic record. Appendix A, Figures A9–A10 provide additional contextual comparisons.

---

## 6. Conclusion

This study provides the first large-scale quantitative evidence that Soviet cultural repression had measurable demographic consequences for Ukrainian creative workers as a professional class. The primary gap of **3.98 years** (75.43 yrs vs 71.45 yrs; Cohen's d=0.292; p<0.001) is verified against the full 8,585-entry dataset, persists after controlling for birth cohort, profession, and region, and is robust to classification error rates well above the validated 3.2%.

Three findings, taken together, constrain the interpretation. First, the **22.02-year deportee deficit** (mean age 49.43 yrs; Cohen's d=1.613) is not a statistical inference — it is the direct mortality signature of state-organised violence, concentrated in 1937 (66 of 194 deported workers died that year, at mean age 42.7). Second, the **internal transfer null result** (+0.36 yrs, p=0.267) demonstrates that the migrant advantage is specific to exit from Soviet jurisdiction, not geographic mobility per se — ruling out the "healthy migrant" hypothesis as the primary explanation. Third, the **cohort concentration** of the gap in the 1880s–1890s birth cohorts (the Executed Renaissance generation) and its near-disappearance for post-Stalinist births matches the historical timeline of repression, not a timeless selection effect.

The current dataset provides a conservative lower bound. The ESU's coverage bias systematically excludes the most severely repressed workers — the very individuals whose absence would widen, not narrow, the observed gap. Adding the 7 confirmed missing workers (mean age 46.7) widens it to ~4.0 years; adding 50 plausible missing workers widens it further.

These findings complement what Ukrainian historians have documented through archival and testimonial evidence: that Soviet cultural policy was associated with substantial mortality differentials among the creative workers who remained under Soviet rule. The numbers do not tell the full story — they cannot capture the individual lives, the works that were never written, the music that was never composed, the theatres that went dark — but they provide a quantitative dimension to the historical record that has not previously existed at this scale.

We make no claim that this analysis is definitive. The selection effects inherent in emigration preclude clean causal inference, and the ESU is not a complete census. Future research should seek to replicate these findings using alternative data sources — particularly Soviet-era repression records, diaspora archives, and memorial databases — and should apply methods capable of addressing the selection problem more rigorously. Priorities include: (1) collecting explicit emigration dates for wave disaggregation; (2) extending to non-creative professional categories; (3) estimating the characteristics of ESU-absent repressed workers; (4) independent replication using the VIVO biographical database.

**The Executed Renaissance is not merely a literary metaphor — it describes a historical demographic event whose mortality signature, this study demonstrates, is quantitatively detectable at scale among the documented figures of Ukrainian cultural life.**

---

## 7. Figure Index

**Figure 1** — *Primary mean age at death comparison.* Bar chart showing mean age at death ± 95% CI for all four migration groups. The central result is immediately visible: migrants (75.43 yrs) outlived non-migrants (71.45 yrs) by 3.98 years, while deportees (49.43 yrs) died 22.02 years earlier than non-migrants. Internal transfers (71.09 yrs) are statistically indistinguishable from non-migrants. Error bars show 95% confidence intervals; the migrant and non-migrant intervals do not overlap.
...
**Figure 3** — *V1 vs V3.0 comparison.* Side-by-side comparison using consistent two-group framing (left USSR vs stayed in Soviet sphere) to enable direct comparison between V1 (n=415, gap=+9.0 yrs) and V3.0 (n=8,585, gap=+4.6 yrs in two-group framing). The gap narrowed because V1's pre-1991 death cutoff excluded long-lived non-migrants who survived into Ukrainian independence, and V1's non-systematic sampling over-represented the most extreme cases. The narrower V3.0 estimate is more conservative and more defensible.

**Figure 4** — *CONSORT exclusion flowchart.* Complete documentation of the exclusion pipeline from 16,215 scraped ESU entries to 8,585 analysable individuals, showing every exclusion category and count. Ensures full transparency about how the analysable cohort was derived and where potential selection effects enter the data.

**Figure 5** — *Deported death year distribution.* Histogram of death years for the deported group (n=194), showing the extreme concentration in 1937: 66 of 194 deported workers (34.0%) died in a single year during the Great Terror. This is the ESU's partial demographic capture of the Sandarmokh massacres and the broader campaign of mass execution of Ukrainian cultural figures.
...
**Figure 7** — *Internal transfer null result.* Direct comparison of internal transfer (71.09 yrs) and non-migrated (71.45 yrs) groups, showing a gap of just +0.36 years (p=0.267, not significant). This is the study's most important control finding: geographic movement within the Soviet system conferred no survival advantage. Only exit from Soviet jurisdiction is associated with longer life.
...
**Figure 10** — *OLS regression coefficient plot.* Forest plot of regression coefficients from Model 2 (adjusted for birth decade, profession, and region). The migrated coefficient falls from +3.98 (unadjusted) to +2.72 (adjusted), showing that approximately 1.26 years of the raw gap is explained by observable selection covariates. The residual 2.72-year adjusted gap remains highly significant (p<0.001).

**Figure 11** — *Cox proportional hazards forest plot.* Hazard ratios and 95% CIs from the adjusted Cox model (controlling for birth decade, profession, region). Migrants: HR=0.777 [0.731, 0.828] — approximately 22% lower instantaneous mortality risk at any given age. Deported: HR=4.40 [3.82, 5.11] — more than four times the mortality hazard. Internal transfers: HR=1.09 — marginally elevated but orders of magnitude smaller than the deported effect.
...
All analysis scripts are available in the `ukraine_v2/` directory. The primary analysis engine is `generate_analysis.py`. Numeric claims in the paper are verified by `check_paper_numbers.py` (184/184 checks pass in V3.0).
