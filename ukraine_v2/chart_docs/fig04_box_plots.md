...
## Key finding (V2.2)
- **Migrated:** Median = 77, box sits highest — most deaths in the 70s-80s
- **Non-migrated:** Median = 73, close to internal transfer
- **Internal transfer:** Median = 72, nearly identical to non-migrated (null result confirmed)
- **Deported:** Median = **45 years**, box dramatically lower, wide spread (IQR spans ~35-60)
...
`ax.set_ylim(0, 110)` is now in `generate_analysis.py`. Y-axis no longer goes negative. Charts regenerated from V2.2 data are clean.
