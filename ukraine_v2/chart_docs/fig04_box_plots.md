...
## Key finding (V2.3)
- **Migrated:** Median = 77, box sits highest — most deaths in the 70s-80s (n=1,280)
- **Non-migrated:** Median = 73, close to internal transfer (n=6,030)
- **Internal transfer:** Median = 72, nearly identical to non-migrated (null result confirmed) (n=1,150)
- **Deported:** Median = **45 years**, box dramatically lower, wide spread (IQR spans ~35-60) (n=183)
...
`ax.set_ylim(0, 110)` is in `generate_analysis.py`. Y-axis no longer goes negative. Charts regenerated from V2.3 data are clean.
