...
A year-by-year count of deaths in the deported group only (V2.3: n=195). Shows the precise timing of when deportees died, which maps directly onto Soviet historical events.
...
## V2.3 note
The deported group grew from n=75 (V2.1) to n=195 (V2.3) after V2.2 date recovery + V2.3 corrections (Куліш death_cause fix + 5 newly reclassified unknown entries). The 1937 spike is now far more visible and historically accurate — most of the newly recovered entries are Sandarmokh massacre victims whose ESU dates had the nested-paren parsing bug.

The 1937 spike decreased slightly from 36.5% (V2.2, n=178) to 35.5% (V2.3, n=195) because the 5 new deported entries added in V2.3 died in years other than 1937.
