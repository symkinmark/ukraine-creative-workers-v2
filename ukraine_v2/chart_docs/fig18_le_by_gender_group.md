...
| Internal transfer | 70.2 | ~978 | 74.8 | ~162 |
| Deported | 48.0 | 167 | 51.5 | 13 |

**Gap within males (migrated vs non-migrated): +3.7 yrs**
**Gap within females (migrated vs non-migrated): +4.4 yrs**
...
- Caption should note deported female n=13 so readers understand the wide CI.
