...
> **UPDATED FOR V2.3** — Numbers below reflect the corrected V2.6 dataset. V2.2 had 8,830 analysable (migrated:1,305 / non_migrated:6,157 / internal:1,179 / deported:189). Old V2.1 numbers were: 6,106 analysable (migrated:927 / non_migrated:4,625 / internal:479 / deported:75).
...
7. **Final analysable dataset: 8,590** (−187 vs V2.2 due to V2.3 corrections)
   - Migrated: 1,280 | Non-migrated: 6,030 | Internal transfer: 1,150 | Deported: 183

## Key finding
Of 16,215 scraped entries, **8,590 (53.3%)** are analytically usable — down slightly from V2.2 (54.5%) because V2.3 applied corrections that excluded 187 entries with impossible ages or classification errors. The main exclusion reason is "still alive or unknown status".
...
V2.3 applied targeted corrections: 19 impossible-age entries (age_at_death < 10, dates clearly wrong) excluded; 77 unknown-status entries reclassified; 3 individual historical corrections (Куліш, Квітко, Маркіш). Net effect: 8,590 analysable — a small decrease from V2.2's 8,830.
